...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
        ...
        <title>Clear Type Flange Guard &amp; Safety Spray Shield ( PTFE - VUE ) | Indana</title>
...
width:30px;
                   ...
                   <nav class="nav" style="top: 0px;">
                       <div class="nav-inner">
                           ...
                           <ul id="main-menu" class="sm sm-blue">
                               ...
                               <!--<li><a class="nav-link" href="quality.php">Quality</a></li>-->
         ...
         <div id="banner-4">
           <div class="content">
                          <div class="content-txt">
                            <h1><span> Clear Type</span> Flange GUARDS </h1>
                          </div>
						  <div class="breadcrumb">
                            ...
                            <span class="current">Clear Type Flange Guards</span>
                        </div>
                    </div>
                  </div> 
               </div>
  <!--product-area start-->
	 ...
	 <div class="panel-about" style="padding:30px 0 30px 0;"> 
         <h2>Clear Type Flange Guards & Spray Safety Shields (PTFE)</h2>
                       ...
                       <div class="post-box noborder">
                           <div class="imgtxt">
                               ...
                               <div class="txts1">
                                 ...
                                 <p>Spray outs are a common incident in most of the industries. For the purpose of safety, spray shields & flange guards are installed on flanges, valves & joints. However there are some industries where immediate visual detection of spray outs is very important. For such applications, Indana has a unique line of Transparent Flange Shield which allow for visual inspection of the joint. </p><br>
                                   <p>
                                       Clear Type PTFE Spray Shields are made from PTFE Fiber Glass Cloth with a clear transparent window in the centre. PTFE is highly resistant to the onslaught of acids, solvents & other corrosive service liquids. These Flange shields have been designed in accordance to the fluid dynamics. This empowers Indana Flange Guards to completely contain the spray out & completely diffuse the pressure of the splash thus providing a safe discharge. 
                                   </p><br />
                                   <p>Clear Type PTFE Safety Spray Shields  or See Through Flange Guards are available for Flanges (Flange Guards), Valves (Valve Spray Shields), Threaded Joints & Fitting (Safety Spray Shields). </p><br />
                                   <p>For Rates & Delivery Time of Clear Type Flange Guards & Shields,<br /> Contact us on: <a href="mailto:info@indanasteel.com?" target="_top" class="black">info@indanasteel.com</a></p><br />
               ...
               <div class="footer-container">
                   ...
                   <div class="footer_box fast-link">
                       ...
                       <ul class="links-list">
                           ...
                           <li class="quicklink"><a href="downloads.php">Downloads</a></li>
                           <li class="quicklink"><a href="quality.php">Quality</a></li>
